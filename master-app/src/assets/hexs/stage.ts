...
export default function StageTransformer (this: any): any {
  this.element = null;
  this.stage = null;
  this.mouse = null;
  this.scaling = null;
...
StageTransformer.prototype.initialize = function (params: { element: any; stage: any; mouse: { over: boolean; down: boolean; moved: boolean; }; scaling: boolean; minScaleX: number; minScaleY: number; maxScaleX: number; maxScaleY: number; panning: boolean; }) {
...
StageTransformer.prototype.mouseDown = function (event: { clientX: any; clientY: any; }) {
...
StageTransformer.prototype.mouseUp = function (event: any) {
  this.mouse.down = false;
};

StageTransformer.prototype.mouseMove = function (event: any) {
  if (this.mouse.down) {
...
StageTransformer.prototype.mouseEnter = function (event: any) {
  this.mouse.over = true;
};

StageTransformer.prototype.mouseLeave = function (event: any) {
  this.mouse.over = false;
};

StageTransformer.prototype.mouseWheel = function (event: any) {
  if (this.scaling) {
    this.scale(event);
  }
};

StageTransformer.prototype.pan = function (event: { clientX: any; clientY: any; }) {
...
StageTransformer.prototype.scale = function (event: { wheelDelta: any; }) {
